  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await api.submitCollecte({
        ...
        district_code: sel.district?.code || null,
        region: sel.region?.name || null,
        region_code: sel.region?.code || null,
        departement: sel.departement?.name || null,
        departement_code: sel.departement?.code || null,
        sous_prefecture: sel.commune?.name || null,
        commune_code: sel.commune?.code || null,
        localite: s(f.localite),
        milieu: s(f.milieu),
        voie_acces: s(f.voie_acces),
        nom_ecole: s(f.nom_ecole),
        statut_juridique: s(f.statut_juridique),
        niveau_enseignement: s(f.niveau_enseignement),
        annee_creation: f.annee_creation ? Number(f.annee_creation) : null,
        annee_scolaire: s(f.annee_scolaire),
        ...
        source_energie: s(f.source_energie),
